    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          type: "select",
          binding: { store: "settings", path: "lyric.chineseScriptPreference" },
          options: [
            { value: "default", labelKey: "settings.chineseScriptPreference.default" },
            { value: "simplified", labelKey: "settings.chineseScriptPreference.simplified" },
            { value: "traditional", labelKey: "settings.chineseScriptPreference.traditional" },
          ],
